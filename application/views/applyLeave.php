  ...
  <div class="col-md-6 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <form class="forms-sample" id="applyLeave">
    ...
    background-color: #2a3038; border: 1px solid #2a3038;" placeholder="0.5 or 1" value="0">
          ...
          <button type="button" class="btn btn-outline-danger btn-icon-text data-bs-toggle='modal' data-bs-target='#exampleModal" id="apply_leave">
            <i class="mdi mdi-file-check btn-icon-prepend"></i> Apply </button>
          <button type="reset" class="btn btn-outline-warning btn-icon-text"  id="resetForm">
