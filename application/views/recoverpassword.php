                ...
                <div class="content-wrapper full-page-wrapper d-flex align-items-center auth login-bg">
                    <div class="card col-lg-4 mx-auto">
                        <div class="card-body px-5 py-5">
                            <h4 class="card-title text-left mb-3">Recover Your Password</h4>
                            <div>
                            </div>
                            <form method="post" action = "<?php base_url ?>recoverpassword">
                                ...
                                <div class="text-center">
                                    <input type="submit" class="btn btn-primary btn-block enter-btn" style="    width: 100px;
" name="update_password" value="Update">
                                </div>
                                <a href="<?php base_url ?>resetpassword" class="forgot-pass">Reset Passwrod</a>
