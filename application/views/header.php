...
<head>
  ...
  <script src="<?php echo site_url ?>javascript/plugin.jquery.min.js"></script>
  <script src="<?php echo site_url ?>javascript/custom.js"></script>

  <link rel="stylesheet" href="<?php echo site_url; ?>css/style.css">
  <link rel="shortcut icon" href="<?php echo site_url; ?>images/favicon.png" />
  <!-- <script src="<?php echo site_url; ?>js/jquery.min.js"></script> -->

  <!-- <script src="<?php echo site_url; ?>js/query.js"></script> -->
</head>
