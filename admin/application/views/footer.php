...
<footer class="footer">
  <div class="d-sm-flex justify-content-center justify-content-sm-between">
    ...
    <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center"><a href="<?php echo base_url; ?>admin/home" target="_blank">Usermanagement admin site</a> from Codelinkinfotech.com</span>
  </div>
</footer>
<!-- partial -->
</div>
