              ...
              <li class="nav-item dropdown">
                <a class="nav-link" id="profileDropdown" href="#" data-bs-toggle="dropdown">
                  <div class="navbar-profile">
                    <img class="img-xs rounded-circle" src="<?php echo site_url; ?>images/admin/<?php if(isset($_SESSION['admin'])){echo $_SESSION['admin'][0]->profile_pic;} ?>" alt="">
                    <p class="mb-0 d-none d-sm-block navbar-profile-name"><?php if(isset($_SESSION['admin'])){echo $_SESSION['admin'][0]->first_name;} ?></p>
                ...
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="profileDropdown">
                  ...
                  <div class="dropdown-divider"></div>
                  <a class="dropdown-item preview-item" href="<?php echo base_url; ?>Admin/profile/<?php if(isset($_SESSION['admin'])){echo $_SESSION['admin'][0]->id;} ?>">
                    <div class="preview-thumbnail">
                      <div class="preview-icon bg-dark rounded-circle">
