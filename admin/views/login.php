              ...
              <div class="card-body px-5 py-5">
                ...
                <form method="post">
                  <div class="form-group">
                    <label>Email *</label>
                    <input type="text" name="email" value="<?php if(isset($_COOCKIE['email'])){echo $_COOCKIE['email'];}?>" class="form-control p_input">
                  </div>
                  <div class="form-group">
                    <label>Password *</label>
                    <input type="text" name="password" value="<?php if(isset($_COOCKIE['password'])){echo $_COOCKIE['password'];}?>" class="form-control p_input">
                  </div>
